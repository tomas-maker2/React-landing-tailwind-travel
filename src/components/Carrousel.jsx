...
const Carrousel = () => {
  ...
  return (
    <div className='max-w-[1240px] mx-auto px-4 py-12 relative flex justify-center items-center'>
        <BsArrowBarLeft onClick={prevSlide} className='absolute top-[50%] text-3xl text-white cursor-pointer left-8'/>
        <BsArrowBarRight onClick={nextSlide} className='absolute top-[50%] text-3xl text-white cursor-pointer right-8'/>
        {
